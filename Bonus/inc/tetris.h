...
** Last update Sun Mar 19 18:16:36 2017 Florian Testu
*/
...
char	**mov1(char **, char *);
char	**mov2(char **, char *, int);
int	check2mov_down(char **, int);
char	**check_down_line(int *, char **);
void	print_1();
void	my_modif_compt_map2(char ***, int);
void	begin_tetris();
void	end_game(char ***, int, t_norm);
int	take_number_map(char *, char ***);
void	new_game_or_not(char ***, t_norm);
...
void	my_algo(char ***, time_t, t_norm);
void	init_ncurse();
char	**window(char **);
