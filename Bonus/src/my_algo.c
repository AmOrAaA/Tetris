...
** Last update Sun Mar 19 17:52:44 2017 Florian Testu
*/
...
int		my_loop(time_t start, char ***tetr, int x, t_norm norm)
{
  static int	score = 0;
...
void		my_algo(char ***tetr, time_t start, t_norm norm)
{
  static  int   x = 0;
  int           lol;
